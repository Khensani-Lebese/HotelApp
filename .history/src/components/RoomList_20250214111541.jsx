...
import { addFavorite, removeFavorite } from "../redux/actions"; // Adjust path as needed
...
const RoomList = ({ rooms = [] }) => {
  ...
  useEffect(() => {
    setFavorites(userFavorites); // Assume userFavorites is coming from a global state or API
  }, [userFavorites]);
