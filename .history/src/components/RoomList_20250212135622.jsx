...
const RoomList = ({ rooms = [] }) => {
  ...
  // Filter rooms by available status
  const availableRooms = roomsFromStore.filter(
        ...
        {availableRooms.map((room) => (
          <div key={room.id} className="room-card">
            ...
            <p className="room-info">
              ...
              {/* Assuming 'available' is a field for the number of rooms */}
            </p>
            ...
            <button
              ...
              disabled={room.available === 0} // Disable button if no rooms are available
            >
