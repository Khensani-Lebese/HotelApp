...
import { FaBed, FaWifi, FaRegSnowflake, FaBath, FaTowel } from "react-icons/fa"; // Import icons
      ...
      <CategoryContainer>
        ...
        <CategorySection>
          ...
          <CategoryFeatures>
            ...
            <FeatureItem>
              <FaBath /> Private balcony with ocean view
            </FeatureItem>
            <FeatureItem>
              <FaTowel /> Premium toiletries
            </FeatureItem>
          </CategoryFeatures>
          <BookNowButton to="/register">Book Now</BookNowButton>
        </CategorySection>
        ...
        <CategorySection>
          ...
          <CategoryFeatures>
            <FeatureItem>
              <FaBed /> Panoramic city views
            </FeatureItem>
            <FeatureItem>
              <FaBath /> Luxury bath amenities
            </FeatureItem>
            <FeatureItem>
              <FaBath /> Personalized concierge service
            </FeatureItem>
          </CategoryFeatures>
          <BookNowButton to="/register">Book Now</BookNowButton>
        </CategorySection>
