...
const MyBookings = () => {
  ...
  const handleSubmitReview = async (roomId, rating, review) => {
    ...
    try {
      ...
      await updateDoc(roomRef, {
        reviews: arrayUnion({ rating, review, user: user.email }),
      });
        ...
        {bookings.length > 0 ? (
          <BookingList>
            ...
            {bookings.paymentStatus === "Paid" && (
              <div>
                <label>Rate this Room (1-5):</label>
                <input
                  type="number"
                  min="1"
                  max="5"
                ...
                <button
                  onClick={() =>
                    handleSubmitReview(booking.roomId, rating, review)
                  }
                >
                  Submit Review
                </button>
